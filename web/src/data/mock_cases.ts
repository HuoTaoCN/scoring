...
export const MOCK_CASES: MockCase[] = [
  ...
  },
  {
    ...
    result: {
      ...
      suggested_reply: "您好！针对您反映的建设路共享单车堵塞盲道并造成安全隐患的问题，我局高度重视。执法人员已于今日下午约谈相关单车企业负责人，责令其立即派员现场清理，并对违规投放行为开具整改通知书。目前盲道已恢复畅通。后续我们将把该区域列为重点巡查点，保障视障人士出行安全。感谢您的监督！",
  ...
  },
  {
    ...
    result: {
      ...
      suggested_reply: "您好！对于您反映的化工厂异味扰民及孩子身体不适的情况，我们深感抱歉和关切。鉴于您提到是多次投诉且涉及健康问题，市环保局执法支队已启动紧急响应机制，今晚将安排突击夜查。对于您提到的废气排放问题，一旦查实将顶格处罚。请您保持电话畅通，执法人员稍后会直接联系您反馈现场检查情况。请相信政府解决问题的决心！",
  ...
  },
  {
    ...
    result: {
      ...
      suggested_reply: "您好！接到您关于学府路网吧违规接纳未成年人的举报后，我局执法大队已立即出动。经现场核查，该场所确实存在违规接纳未成年人行为。我们已当场下达停业整顿通知书，并立案进一步调查处理。感谢您的举报，我们将持续净化校园周边环境！",
  ...
  },
  {
    ...
    result: {
      ...
      suggested_reply: "（系统提示：此工单不应直接回复，请修改处理方式为‘转办’，目标部门：区城管执法局）",
