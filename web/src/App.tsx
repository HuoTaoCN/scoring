          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold tracking-tight hidden md:block">
                GovInsight-AI SC <span className="text-sm font-normal text-slate-400 ml-1">工单办理质量智能检测系统</span>
              ...
              <p className="text-xs text-slate-400 hidden md:block">Smart Case Handling Quality Supervision System</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
