...
**GovInsight-AI SC**
**Smart Case Handling Quality Supervision System**
...
**GovInsight-AI (SC)** 是一个基于 **大语言模型 (LLM)** 的政务热线工单质量检测系统。它专注于解决政务热线（如 12345）中**“群众诉求”**与**“办理答复”**的一致性与质量校验痛点。
...
**GovInsight-AI (SC)** 将 LLM 的语义理解能力引入质检环节，实现对**回复内容**的全量、实时、客观智能检测。
